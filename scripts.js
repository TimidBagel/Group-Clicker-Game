...
const kibbleHele = new Building(35, 150, "Kibble Helecopter Landing", "kibblehele")
const kibbleSpire = new Building(120, 500, "Kibble Spire", "kibblespire")
const kibbleShip = new Building(500, 2000, "Kibble Shipment", "kibbleship")
const kibbleTrade = new Building(2500, 10000, "Kibble Trade Center", "kibbletrade")
const kibbleFound = new Building(350, 50000, "Kibble Foundry", "kibblefound")
const kibbleSpace = new Building(950, 200000, "Kibble Space Port", "kibblespace")
const kibbleNano = new Building(5000, 400000, "Kibble Nano Enterprise", "kibblenano")
const kibbleUniverse = new Building(7500, 1000000, "Kibble Universe Company", "kibbleuniverse")
